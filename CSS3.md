...
html {
     ...
     * 
     ...
     物理像素点：375像素大小（手机尺寸），但是手机屏幕是高清屏，是物理像素点的两倍

     设计图：一般会以iphone6作为参考
     iphone6：375 * 667 ，原型图大小：750 * 1334
     ...
     iphone6，7
     html字体== 8px  = 375/750 * 16px(参考图rem的基数)
     淘宝：html字体 = 75px =375/750 * 150px（参考值的一半）

     iphone5:
     html字体==  6.83px = 320/750 *16px （16px是参考图rem基数）
     * */
}
```
